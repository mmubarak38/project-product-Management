...
const updateProfile = async(req, res) => {
    try {
        ...
        const { fname, lname, email, phone, password, address, profileImage } = requestUpdateBody
        ...
        const encryptedPassword = await bcrypt.hash(requestUpdateBody.password, saltRounds)
